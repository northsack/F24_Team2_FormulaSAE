...
We have also directed our attention to studying powertrain projects from other leading universities, such as the University of Wisconsin-Madison and the Rochester Institute of Technology, which won this year's Formula SAE competition. This said, RIT's successful approach to making a lightweight vehicle that uses advanced cooling techniques is especially valuable to our research because it provides us with the chance to learn from a proven strategy employed by a top competitor. With the components provided by the Tennessee Technological University, we have undertaken an innovative design of our vehicle's powertrain, which places an emphasis on the strategies we learned from the aforementioned teams. Yet our design must also meet the safety and efficiency standards laid out by the competition. Overall, our team's extensive research into other projects will enable us to make better calculations, decisions, and design strategies contributing to the creation of a vehicle that is not only competitive but also reliable.
